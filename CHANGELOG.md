...
## [2.7.0](https://github.com/Panandika/kasir-pos/compare/v2.6.1...v2.7.0) (2026-07-05)
...
* **ci:** schema-drift guard + columns-aligned mappings (Phase B US-B3) ([ee06be1](https://github.com/Panandika/kasir-pos/commit/ee06be1e57d6f807d7244c058491a248cc859030))
...
* **cloudsync:** add sync_queue recreation migration for Gate A0.3 ([c3cc813](https://github.com/Panandika/kasir-pos/commit/c3cc81301fce802eb32a62b40c50643f028030df))
* **cloudsync:** capacity monitoring + final ops runbook (Phase E) ([327a3bf](https://github.com/Panandika/kasir-pos/commit/327a3bfdbc0f82216600ccfeb7ca82e5797a4367))
* **cloudsync:** expand TableMappings to all 19 mirror tables (Phase C US-C1) ([dc3c2ec](https://github.com/Panandika/kasir-pos/commit/dc3c2ecbea4d73bd2b3c63753cc26c3cfebbae03))
* **cloudsync:** FK constraints + orphan scanner + backoff policy (post-Phase E) ([3fd27c4](https://github.com/Panandika/kasir-pos/commit/3fd27c401d79e747fa6f7d5a63d540603466026f))
* **cloudsync:** health endpoint + remote health + Litestream drill (Phase D) ([88904d0](https://github.com/Panandika/kasir-pos/commit/88904d0e9897a1d9a4e7c47114386fdeb0546c5e))
* **cloudsync:** InitialLoader CLI mode (Phase C US-C2) ([ade2fcd](https://github.com/Panandika/kasir-pos/commit/ade2fcd2516b3958acf3d77b7e167c147979bce4))
* **cloudsync:** mapper generator + 5 core TableMappings (Phase B US-B1+B2) ([726a97a](https://github.com/Panandika/kasir-pos/commit/726a97a05a6db8fd459f45bc9d4b60fe679a0b51))
* **cloudsync:** Phase A end-to-end integration test + proof doc ([3423325](https://github.com/Panandika/kasir-pos/commit/342332598a9c5e5a3de7d647276c42786291624e))
* **cloudsync:** ProductMapper + PostgresSink + OutboxReader for products ([22f394e](https://github.com/Panandika/kasir-pos/commit/22f394ed10496068f2092feb17602036caec2350))
* **cloudsync:** scaffold Kasir.CloudSync + Kasir.CloudSync.Tests projects ([80116cc](https://github.com/Panandika/kasir-pos/commit/80116cc7f2940c17b7e9722a25b5055dfa4b0709))
...
* **sync:** add cloud_synced bookkeeping to sync_queue outbox ([7d07836](https://github.com/Panandika/kasir-pos/commit/7d07836060d7ac7afba91e688a54526fde4b0170))
...
* **tools:** add Gate A0.1 TLS smoke test console app ([581c4af](https://github.com/Panandika/kasir-pos/commit/581c4af455dbea27654c89ae29473c0b1fc52b49))
...
* **deps:** bump SQLitePCLRaw.bundle_e_sqlite3 2.1.10 -&gt; 3.0.3 ([41277b9](https://github.com/Panandika/kasir-pos/commit/41277b9f7c4ca29afb3b52ca024e4b412e4fa4c7))
...
* **shift:** correct expected drawer cash reconciliation ([3438df6](https://github.com/Panandika/kasir-pos/commit/3438df6886a3fdc00504a3fbabf8711daa96de13))
