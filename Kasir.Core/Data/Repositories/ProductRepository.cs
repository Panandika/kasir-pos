    ...
    public class ProductRepository
    {
        ...
        private static Product MapProduct(SqliteDataReader reader)
        {
            return new Product
            {
                ...
                Price = SqlHelper.GetLong(reader, "price"),
                Price1 = SqlHelper.GetLong(reader, "price1"),
                Price2 = SqlHelper.GetLong(reader, "price2"),
                Price3 = SqlHelper.GetLong(reader, "price3"),
                Price4 = SqlHelper.GetLong(reader, "price4"),
                BuyingPrice = SqlHelper.GetLong(reader, "buying_price"),
