...
public partial class PayablesView : UserControl
{
    ...
    private async void ProcessPayment()
    {
        ...
        {
            await MsgBox.Show(NavigationService.Owner, "Pilih supplier terlebih dahulu.");
            return;
        }
        ...
        {
            await MsgBox.Show(NavigationService.Owner, "Masukkan jumlah pembayaran.");
            return;
        }
        ...
        {
            await MsgBox.Show(NavigationService.Owner, "Gagal memproses pembayaran: " + ex.Message);
        }
    }
