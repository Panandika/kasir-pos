...
public partial class ProductReportView : UserControl
{
    ...
    private readonly List<ProductRow> _allRows = new();
    ...
    private void GenerateReport()
    {
        _rows.Clear();
        _allRows.Clear();
        var products = new ProductRepository(DbConnection.GetConnection()).GetAllActive();
    ...
    private async void ExportReport()
    {
        ...
        {
            Title = "Export Excel",
            SuggestedFileName = "Master_Barang",
