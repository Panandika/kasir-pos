...
public partial class ShiftWindow : Window
{
    ...
    public ShiftWindow(int cashierId)
    {
        InitializeComponent();
    ...
    private async System.Threading.Tasks.Task OpenShift()
    {
        ...
        {
            await MsgBox.Show(this, "Shift sudah terbuka.");
            return;
        }
        ...
        RefreshStatus();
        await MsgBox.Show(this, "Shift dibuka.");
    }
    ...
    private async System.Threading.Tasks.Task CloseShift()
    {
        if (CurrentShift == null)
        {
            await MsgBox.Show(this, "Tidak ada shift terbuka.");
            return;
        }
