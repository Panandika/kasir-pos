...
public partial class ReturnWindow : Window
{
    ...
    {
        var (ok1, codeVals) = await InputDialogWindow.Show(this, "Tambah Item Retur", new[] { "Kode Barang" }, new[] { "" });
        ...
        var (ok2, vals) = await InputDialogWindow.Show(this, "Detail Retur",
            new[] { "Qty Retur", "Harga" },
            new[] { "1", defaultPrice });
        if (!ok2) return;
    ...
    {
        if (string.IsNullOrEmpty(_vendorCode)) { await MsgBox.Show(this, "Pilih supplier."); return; }
