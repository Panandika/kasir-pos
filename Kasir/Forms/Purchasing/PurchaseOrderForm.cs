...
namespace Kasir.Forms.Purchasing
{
    public class PurchaseOrderForm : BaseForm
    {
        ...
        private void InitializeLayout()
        {
            ...
            txtVendor = new TextBox { Location = new Point(90, 5), Width = 300, BackColor = ThemeConstants.BgInput, ForeColor = ThemeConstants.FgPrimary, Font = ThemeConstants.FontInputSmall, ReadOnly = true };
            ...
            dgvItems.Columns.Add("Name", "Nama Barang"); dgvItems.Columns["Name"].FillWeight = 250;
        ...
        private void AddItem()
        {
                ...
                new[] { "1", (product.BuyingPrice / 100.0).ToString("F0") }))
            {
                if (dlg.ShowDialog(this) == DialogResult.OK)
                {
                    ...
                    _items.Add(new OrderItem { ProductCode = code, ProductName = product.Name, Quantity = qty, UnitPrice = (int)(price * 100m), Value = (long)(price * 100m) * qty });
                    RefreshGrid();
                }
            }
        }
