...
namespace Kasir.Forms.Reports
{
    public class SalesReportForm : BaseForm
    {
        ...
        private void InitializeLayout()
        {
            ...
            var lblFrom = new Label { Text = "From:", Location = new Point(10, 15), AutoSize = true, ForeColor = Color.Gray };
            ...
            var lblTo = new Label { Text = "To:", Location = new Point(200, 15), AutoSize = true, ForeColor = Color.Gray };
            ...
            dgvReport.Columns["No"].Width = 40;
            dgvReport.Columns["JournalNo"].Width = 160;
            dgvReport.Columns["Date"].Width = 100;
            dgvReport.Columns["Cashier"].Width = 60;
            dgvReport.Columns["Items"].Width = 50;
            dgvReport.Columns["Gross"].Width = 100;
            dgvReport.Columns["Disc"].Width = 80;
            dgvReport.Columns["Total"].Width = 100;
            dgvReport.Columns["Cash"].Width = 100;
            dgvReport.Columns["Card"].Width = 80;
            dgvReport.Columns["Status"].Width = 60;
